    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-600 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-white text-lg">Loading interview options...</p>
        </div>
      </div>
    );
  }
              ...
              <div className="p-6">
                ...
                <div className="space-y-3 mb-6">
                  <div className="flex items-center space-x-3 text-gray-600">
                    ...
                    <span className="text-sm font-medium">{template.duration} minutes</span>
                  </div>
                  <div className="flex items-center space-x-3 text-gray-600">
                    <BookOpen className="w-5 h-5 text-green-500" />
                    <span className="text-sm font-medium">{template.totalQuestions} questions</span>
                  </div>
                  <div className="flex items-center space-x-3 text-gray-600">
                    <Target className="w-5 h-5 text-purple-500" />
                    <span className="text-sm font-medium">{template.passingScore}% passing score</span>
                  </div>
                </div>
